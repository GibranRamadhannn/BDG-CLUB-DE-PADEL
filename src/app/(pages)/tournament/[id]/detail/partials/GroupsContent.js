...
export default function GroupsContent() {
  return (
    ...
    <>
      {/* Group A */}
      <div className="md:max-w-2xs w-full mb-3 min-h-fit p-4 bg-effervescent-blue rounded-2xl shadow-lg text-white font-montserrat">
        {/* Header */}
        <div className="flex items-center bg-neptune-blue text-white px-4 py-2 rounded-t-xl mb-4 relative">
          <h2 className="w-full text-center font-semibold text-md">GROUP A</h2>
        </div>
      ...
      <div className="md:max-w-2xs w-full mb-3 min-h-fit p-4 bg-effervescent-blue rounded-2xl shadow-lg text-white font-montserrat">
        {/* Header */}
        <div className="flex items-center bg-neptune-blue text-white px-4 py-2 rounded-t-xl mb-4 relative">
          <h2 className="w-full text-center font-semibold text-md">GROUP B</h2>
        </div>
      ...
      <div className="md:max-w-2xs w-full mb-3 min-h-fit p-4 bg-effervescent-blue rounded-2xl shadow-lg text-white font-montserrat">
        {/* Header */}
        <div className="flex items-center bg-neptune-blue text-white px-4 py-2 rounded-t-xl mb-4 relative">
          <h2 className="w-full text-center font-semibold text-md">GROUP C</h2>
        </div>
      ...
      <div className="md:max-w-2xs w-full mb-3 min-h-fit p-4 bg-effervescent-blue rounded-2xl shadow-lg text-white font-montserrat">
        {/* Header */}
        <div className="flex items-center bg-neptune-blue text-white px-4 py-2 rounded-t-xl mb-4 relative">
          <h2 className="w-full text-center font-semibold text-md">GROUP D</h2>
        </div>
